...
Full Stack Developer · AI · Infra · Cloud · FPGA · Automation
...
<p>
  ...
  <img src="https://img.shields.io/badge/Verilog-8A8A8A?style=flat-square&logoColor=white"/>
  <img src="https://img.shields.io/badge/Shell-121011?style=flat-square&logo=gnubash&logoColor=white"/>
  <img src="https://img.shields.io/badge/FPGA-7A7A7A?style=flat-square&logoColor=white"/>
</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/gRPC-2E6CE6?style=flat-square&logo=grpc&logoColor=white"/>
...
<p>
  ...
  <img src="https://img.shields.io/badge/AI_CLI-222222?style=flat-square&logo=gnubash&logoColor=white"/>
</p>
...
### 🔹 AI Agent Workflow
- Multi-Model Orchestration (ChatGPT / Claude / Gemini / Local LLM)
- Task Decomposition → Planning → Execution 구조 설계
- API / DB / Tool 연동 기반 Agent 시스템 구축
- CLI / Script 기반 자동화 Workflow 설계
- Backend + AI Agent 통합 아키텍처 구현

### 🔹 Prompt Engineering
- Role / Persona 기반 프롬프트 설계
- Chain-of-Thought / Step reasoning 적용
- JSON / Schema 기반 구조화 응답 설계
- Few-shot / Instruction 기반 성능 개선
- Token 최적화 및 응답 품질 튜닝

### 🔹 AI Development Workflow
- Codex / CLI 기반 개발 자동화
- AI 코드 생성 + 리팩토링 + 리뷰 활용
- 반복 작업 자동화 및 생산성 극대화
- AI 기능을 실제 서비스에 적용 (챗봇 / 분석 / 추천)
